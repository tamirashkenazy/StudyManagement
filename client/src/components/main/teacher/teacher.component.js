    ...
    return (
        teacher ?
            <div>
                ...
                {Dialog_generator(openedPopups.send_message, () => setOpenedPopups(Object.assign({}, getOpenedPopup(false, false, false, false))), "הודעות","mail_outline", { id: user._id }, (id) => SendMessage(id))}
                <br></br>
