    ...
    return (
        student ?
            <div>
                ...
                {/* All the dialogs render on rendering */}
                ...
                {/* The Grid view of the tables in the student page */}
            ...
            :
            <SpinnerLoader header={"טוען עמוד"}> </SpinnerLoader>
    )
